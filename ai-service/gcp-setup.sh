...
echo "  2. Export the runtime SA for your shell (add to ~/.bashrc to persist):"
echo "       export AI_SERVICE_SA=\"$SA_EMAIL\""
echo "  3. Deploy ai-service with:  --service-account \"\$AI_SERVICE_SA\""
echo "  4. Pass GCP_PROJECT_ID as a Cloud Run env var so the app can reach Secret Manager."
